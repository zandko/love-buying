    ...
    public function run()
    {
        $productData = [
            [
                ...
                "price" => "399.00",
                "skus" => [
                    ["title" => "8GB 黑色", "description" => "8GB 2400 DDR4 黑色", "price" => "549.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "8GB 绿色", "description" => "8GB 2400 DDR4 绿色", "price" => "529.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "16GB", "description" => "2400 16GB", "price" => "1299.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "4GB", "description" => "2400 4GB", "price" => "399.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                ],
                "properties" => [
                    ["name" => "品牌名称", "value" => "金士顿"],
                    ["name" => "内存容量", "value" => "8GB"],
            ...
            [
                ...
                "price" => "489.00",
                "skus" => [
                    ["title" => "8GB DDR4 2400", "description" => "8GB DDR4 2400 XPG单条", "price" => "489.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "4GB 万紫千红 DDR4 2133", "description" => "4GB 万紫千红 DDR4 2133", "price" => "489.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                ],
                "properties" => [
                    ["name" => "品牌名称", "value" => "威刚"],
                    ["name" => "传输类型", "value" => "DDR4"],
            ...
            [
                ...
                "price" => "239.00",
                "skus" => [
                    ["title" => "DDR3 1600 8G", "description" => "DDR3 1600 8G", "price" => "439.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "DDR3 1600 4G", "description" => "DDR3 1600 4G", "price" => "239.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "DDR3 1333 4G", "description" => "DDR3 1333 4G", "price" => "259.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                ],
                "properties" => [
                    ["name" => "品牌名称", "value" => "金士顿"],
            ...
            [
                ...
                "price" => "489.00",
                "skus" => [
                    ["title" => "16GB 3000", "description" => "16GB 3000 8GB*2", "price" => "1199.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "16GB 3600", "description" => "16GB 3600 8GB*2", "price" => "1379.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "8GB 2400", "description" => "8GB 2400 DDR4", "price" => "489.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "8GB 3000", "description" => "8GB 3000 DDR4", "price" => "519.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                ],
                "properties" => [
                    ["name" => "品牌名称", "value" => "影驰"],
                    ["name" => "传输类型", "value" => "DDR4"],
            ...
            [
                ...
                "price" => "359.00",
                "skus" => [
                    ["title" => "DDR4 8G 2400", "description" => "DDR4 8G 2400", "price" => "519.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "DDR4 4G 2400", "description" => "DDR4 4G 2400", "price" => "359.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "DDR4 8G*2 2400", "description" => "DDR4 8G*2 2400", "price" => "1279.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "DDR4 16G 2400", "description" => "DDR4 16G 2400", "price" => "1279.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                ],
                "properties" => [
                    ["name" => "品牌名称", "value" => "海盗船"],
                    ["name" => "内存容量", "value" => "16GB"],
            ...
            [
                ...
                "price" => "539.00",
                "skus" => [
                    ["title" => "DDR4 2400 8G", "description" => "DDR4 2400 8G", "price" => "539.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "DDR4 2133 8G", "description" => "DDR4 2133 8G", "price" => "539.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "DDR4 2666 8G", "description" => "DDR4 2666 8G", "price" => "589.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                    ["title" => "DDR4 2400 16G", "description" => "DDR4 2400 16G", "price" => "1199.00","image" => "https://img.alicdn.com/bao/uploaded/i2/TB1iqkaLVXXXXagXXXXObG1FpXX_091208.jpg_b.jpg",],
                ],
                "properties" => [
                    ["name" => "品牌名称", "value" => "三星"],
                    ["name" => "传输类型", "value" => "DDR4"],
        ...
        foreach ($productData as $data) {
            ...
            foreach ($data['skus'] as $sku) {
                $product->product_sku()->create(array_merge($sku, ['stock' => 999]));
            }
            // 遍历商品数据中的 properties 字段
            foreach ($data['properties'] as $attribute) {
                $product->product_property()->create($attribute);
            }
        }
    }
}