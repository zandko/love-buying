            ...
            <div class="content-top-w">
                ...
                <div class="row content-main-w">
                    ...
                    <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 main-right">
                        ...
                        <div class="module deals-layout1">
                            <div class="head-title">
                                <div class="modtitle">
                                    ...
                                    <a class="viewall" href="�route=product�special.html">查看全部</a>
                        ...
                        <!-- Category Slider 1 -->
                        <div id="so_category_slider_1" style="padding:3px" class="so-category-slider container-slider module cateslider1">
                            <div class="modcontent">
                                <div class="page-top">
