    ...
    <div id="content">
                                ...
                                <div id="so_extra_slider_1" class="so-extraslider">
                                    ...
                                    <div class="yt-content-slider extraslider-inner" data-rtl="yes"
                                        ...
                                        <div class="item ">
                                            ...
                                            @foreach($sold_count as $sold)
                                            <div class="product-layout item-inner style1 ">
                                                <div class="item-image">
                                                    <div class="item-img-info">
                                                        <a href="{{ route('products.show',['product'=>$sold->id]) }}" target="_self" title="Mandouille short ">
                                                            <img src="{{ $sold->image_url }}" alt="{{ $sold->title }}">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="item-info">
                                                    <div class="item-title">
                                                        <a href="{{ route('products.show',['product'=>$sold->id]) }}" target="_self" title="{{ $sold->title }} short">{{ str_limit($sold->title,15) }}</a>
                                                    </div>
                                                    <div class="rating">
        ...
        <div class="row content-main-w">
                            ...
                            <div class="yt-content-slider extraslider-inner" data-rtl="yes" data-pagination="yes"
                                ...
                                <div class="item ">
                                    ...
                                    <div class="product-layout item-inner style1 ">
                                        <div class="item-image">
                                            <div class="item-img-info">
                                                <a href="{{ route('products.show',['product'=>$d->id]) }}" target="_self" title="{{ $d->title }} "><img
                                                            src="{{ $d->image_url }}" alt="{{ $d->title }}"></a>
                                            </div>
                                        </div>
                                        <div class="item-info">
                                            <div class="item-title">
                                                <a href="{{ route('products.show',['product'=>$d->id]) }}" target="_self" title="{{ $d->title }}">{{ str_limit($d->title,15) }}</a>
                                            </div>
                                            <div class="rating">
            ...
            <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12 main-right">
                ...
                <!-- Category Slider 1 -->
                <div id="so_category_slider_1" @if($k%2==0) class="so-category-slider container-slider module cateslider1" @else class="so-category-slider container-slider module cateslider2" @endif>
                    <div class="modcontent">
                        <div class="page-top">
                            ...
                            <div class="item-sub-cat">
                                <ul>
                                    ...
                                    @foreach($category['children'] as $k => $children)
                                        @if($k %2 ==0)
                                        <li><a href="#" title="Smartphone" target="_self">{{ $children['name'] }}</a></li>
                                        @endif
                                    @endforeach
