        ...
        <div class="row">
            ...
            <div class="col-sm-9" id="content">
                ...
                <user-addresses-create-and-edit inline-template>
                    @if($addresses->id)
                    <form action="{{ route('user_addresses.update',['user_address'=>$addresses->id]) }}" method="post">
                        {{ method_field('PUT') }}
                        @else
                            ...
                            <div class="col-sm-6">
                                <fieldset id="shipping-address">
                                    ...
                                    <div id="app" class="form-group required">
                                        <select-district :init-value="{{ json_encode([$addresses->province, $addresses->city, $addresses->district]) }}" @change="onDistrictChanged" inline-template>
                                ...
                                <fieldset id="personal-details">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <input type="text" class="form-control" id="input-address"
                                               value="{{ old('address',$addresses->address) }}" name="address">
                                    </div>
                                    <div class="form-group required">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <input type="text" class="form-control" id="input-contact_name"
                                               value="{{ old('zip', $addresses->contact_name) }}" name="contact_name">
                                    </div>
                                    <div class="form-group required">
                                        <label for="input-zip" class="control-label">电话</label>
                                        <input type="text" class="form-control" id="input-contact_phone"
                                               value="{{ old('zip', $addresses->contact_phone) }}" name="contact_phone">
                                    </div>
                                </fieldset>
                                <br>
                            </div>
